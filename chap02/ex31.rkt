...
(write-file "first-name.dat" "Bong")
(write-file "last-name.dat" "Ho")
(write-file "signature.dat" "Bong Joon-Ho")

(main "first-name.dat" "last-name.dat" "signature.dat" "letter-out.dat")
